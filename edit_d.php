...
<div class="row" >
  ...
  <form  role="form" method="POST" action="<?php echo $accion;?>" enctype="multipart/form-data">
   ...
   <div class="row">
	 ...
	 <div class="form-group">
 	  ...
 	  <div class="form-group">
 	    <div class="col-xs-12">
 	      <label>Video (URL o archivo .mp4)</label>
 	      <input class="form-control" name="video_url" placeholder="http(s)://... o YouTube URL" value="<?php echo isset($video)?htmlspecialchars($video):''; ?>">
 	      <input type="file" name="video_file" accept="video/mp4" class="form-control" style="margin-top:8px;">
 	      <?php if (!empty($video)) echo '<p class="help-block">Video actual: <a href="#" onclick="cargar_pdf(\'#capa_d\',\''.addslashes($video).'\');return false;">Ver</a></p>'; ?>
 	    </div>
 	  </div>
}
?>
