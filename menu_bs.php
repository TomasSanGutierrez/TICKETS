   ...
   <nav class="navbar navbar-inverse navbar-static-top navbar2" role="navigation" >
      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="index.php">
          <img src="images/logo.svg" alt="Logo" style="height:30px;display:inline-block;margin-right:8px;">
          Tomas Gutierrez
        </a>
      </div>
      ...
      <ul class="nav navbar-nav ">
		...
		<?php 
		if (isset($_SESSION['username']) && isset($_SESSION['rol']) && strtolower($_SESSION['rol'])=='administrador'){
	  ...
	  <?php if (isset($_SESSION['rol']) && $_SESSION['rol']=='administrador'){
	    echo '<li class="navbar-text" style="padding-left:10px;">Usuarios en línea: <span id="online_users">0</span></li>';
	  }
	  ?>
...
<!-- Socket.io client updates online users (requires node server at port 3001) -->
<script src="https://cdn.socket.io/4.5.0/socket.io.min.js" integrity="" crossorigin="anonymous"></script>
<script>
  (function(){
    try{
    ...
    }catch(e){console.log('Socket.io connect error',e)}
  })();
</script>
<?php } ?>
